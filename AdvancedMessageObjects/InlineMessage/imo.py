...
class Module:
	...
	def sleep(self):
		if self.type == 'settings':
			warn('хуй')
			r = requests.get('https://api.telegram.org/bot'+token+'/messageDelete?chat_id='+str(self.msg.chat.id)+'&message_id='+str(self.msg.message_id))
			return None
